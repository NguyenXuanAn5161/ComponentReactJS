  ...
  return (
    ...
    >
      <nav className="bg-yellow-200 border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
          ...
          <div className="flex items-center lg:order-2">
            <div className="xl:block lg:block md:hidden sm:hidden xs:hidden custom-btn flex">
              <div className="ml-2 flex">
                ...
                <div
                  className="ml-2 flex cursor-pointer items-center gap-x-1 rounded-md border-none py-2 px-4 hover:bg-gray-100"
        ...
        <div className="xl:block lg:block md:hidden sm:hidden xs:hidden custom-btn">
